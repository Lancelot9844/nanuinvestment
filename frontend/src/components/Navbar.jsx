...
function Navbar() {
  ...
  return (
    <nav ref={navbarRef} className="navbar-custom">
      <div className="navbar-inner">
        ...
        >
          <ul className="navbar-nav">
            ...
            {/* NEWS */}
            <li className="nav-item">
              <a className="nav-link" href="/#news" onClick={closeMenu}>
                NEWS &amp; ACTIVITIES
              </a>
            </li>
            ...
            {/* NOTICE */}
            <li className="nav-item">
              <a className="nav-link" href="/#notices" onClick={closeMenu}>
                NOTICE
              </a>
            </li>
            ...
            {/* DOWNLOADS */}
            <li className="nav-item">
              <a className="nav-link" href="/#downloads" onClick={closeMenu}>
                DOWNLOADS
              </a>
            </li>
