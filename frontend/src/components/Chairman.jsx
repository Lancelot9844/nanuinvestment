              ...
              <div className="col-lg-8 col-md-7 col-sm-12">
                ...
                <div className="owner-info">
                  ...
                  <p className="owner-message">
                    Our journey continues with a vision to uplift
                    communities through mutual trust, strong
                    cooperation, and reliable financial support.
                  </p>
                  ...
                  <div className="owner-details-grid">
                    ...
                    <span>
                      ...
                      5+ Years in Co-operative Sector
                    </span>
